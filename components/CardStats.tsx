...
const CardStats = ({title, number, trend, numberTrend}: CardStatsProps) => {
    ...
    return (
        <div className="bg-white px-5 py-4 rounded-[15px] border border-[#D2D2D2] flex flex-col gap-2">
            <h4 className="text-[#626262] uppercase font-medium text-sm tracking-wide">{title}</h4>
            <h3 className="text-black font-semibold text-3xl tracking-wide">{number}</h3>

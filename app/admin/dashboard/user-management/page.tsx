...
export default function UserManagementPage() {
  const { openEditModal, openAddModal, openDeleteModal, isDeleteModalOpen, closeDeleteModal, selectedUser } = useUserStore()
  ...
  // Definisi Kolom untuk TableTemplate
      ...
      <div className="bg-white border border-gray-200 border-t-0 rounded-b-lg flex flex-col shadow-sm min-h-[calc(100vh-160px)]">
        ...
        <div className="flex items-center justify-between px-8 py-5 border-t border-gray-200 bg-white mt-auto rounded-b-lg">
          <p className="text-sm text-gray-500 font-medium">
            Showing <span className="font-bold text-gray-900">{filteredUsers.length}</span> of <span className="font-bold text-gray-900">{dummyUsers.length}</span> registered users
          </p>
